"""
tools.py — Day 10a: TravelBot tools (same as Day 10)
=====================================================
Identical to day10/tools.py. Provides the four mock-data tools used by
the multi-agent backend:

  get_booking_status   — look up a flight booking by ID or route
  get_attractions      — list attractions for a city (with optional filters)
  get_weather_forecast — day-by-day weather for a city
  search_hotels        — find hotels by city and optional budget tier

Set SIMULATE_HOTEL_ERROR=1 in .env to make search_hotels return an error,
exercising the graceful error path in the frontend.
"""
...
def search_hotels(
    ...
    Returns:
        ...
        Returns an error dict if SIMULATE_HOTEL_ERROR=1 is set.
    """
