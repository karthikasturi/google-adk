...
Day 09 uses in-memory sessions — the focus here is multi-agent
orchestration, not session persistence (see Day 04 for that pattern).
"""
...
APP_NAME = "day09-orchestration-demo"
