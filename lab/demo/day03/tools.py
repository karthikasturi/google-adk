"""
tools.py — Mock travel tools for Day 03
-----------------------------------------
Each function is a plain Python callable with type hints and a docstring.
ADK auto-generates the JSON schema from these — no decorator needed.
