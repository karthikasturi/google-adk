"""
agent.py — Day 10: TravelBot agents for the Chainlit generative-UI demo
========================================================================
Three specialists behind a concierge router, wired with ADK's native
sub_agents routing (transfer_to_agent). The multi-agent pattern is the
same as Day 09a Pattern A; Day 10's focus is on the Chainlit UI layer
that wraps these agents, not on new orchestration patterns.
...
ADK Web (Pattern A preview):
    adk web .   ← discovers root_agent = concierge_agent
"""
